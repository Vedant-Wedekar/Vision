...
,
{
  ...
  length: "2h 5m",
  languages: "English",
  description: "A covert intelligence officer must prevent global chaos from an unseen enemy.",
  keywords: ["Action", "Espionage", "Thriller"],
  img: "",
  post: "https://yourcdn.com/premium_movie3.jpg",
  video: null,
...
},
{
  ...
  length: "2h 20m",
  languages: "English",
  description: "A deep-space crew uncovers a cosmic anomaly that threatens all life.",
  keywords: ["Sci-Fi", "Adventure", "Thriller"],
  img: "",
  post: "https://yourcdn.com/premium_movie4.jpg",
  video: null,
  cast: ["Oscar Isaac", "Rebecca Ferguson"]
},
{
  id: 1003,
  title: "The Golden Oath",
  year: 2024,
  rating: "8.7",
  category: "premium",
  caste: "premium",
  length: "2h 15m",
  languages: "Hindi",
  description: "An ancient warrior’s promise returns to haunt his bloodline in modern times.",
  keywords: ["Fantasy", "Drama", "Adventure"],
  img: "",
  post: "https://yourcdn.com/premium_movie5.jpg",
  video: null,
  cast: ["Ranveer Singh", "Kriti Sanon"]
},
{
  id: 1004,
  title: "Neon Pulse",
  ...
  length: "1h 50m",
  languages: "English",
  description: "In a cyberpunk future, a rogue hacker takes on a mega-corporation’s AI overlord.",
  keywords: ["Sci-Fi", "Action", "Cyberpunk"],
  img: "",
  post: "https://yourcdn.com/premium_movie6.jpg",
  video: null,
  cast: ["Zendaya", "John Boyega"]
},
{
  id: 1005,
  ...
  length: "2h 25m",
  languages: "English",
  description: "After the fall of civilization, survivors fight for control over a dying world.",
  keywords: ["Post-Apocalyptic", "Action", "Drama"],
  img: "",
  post: "https://yourcdn.com/premium_movie7.jpg",
  video: null,
  cast: ["Charlize Theron", "Pedro Pascal"]
},
{
  id: 1006,
  ...
  length: "2h 10m",
  languages: "Hindi",
  description: "A detective trapped between illusion and reality hunts the truth behind a mystical crime.",
  keywords: ["Mystery", "Thriller", "Fantasy"],
  img: "",
  post: "https://yourcdn.com/premium_movie8.jpg",
  video: null,
...
},
{
  ...
  length: "2h 18m",
  languages: "English",
  description: "A tech genius discovers a hidden algorithm that can rewrite reality itself.",
  keywords: ["Tech", "Thriller", "Mind-Bending"],
  img: "",
  post: "https://yourcdn.com/premium_movie9.jpg",
  video: null,
  cast: ["Benedict Cumberbatch", "Ana de Armas"]
}
,
