...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center loginBg pr-75">
      <div className="a flex mb-190 ">
  ...
  className="relative z-10 w-full max-w-md p-10 rounded-2xl backdrop-blur-md ml-170 bg-white/600 border border-white/10 shadow-2xl"
>
        ...
        <input
          className="w-full p-3 mb-5 rounded-lg bg-white/10 text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-[#7962b3] transition"
          placeholder="Email"
          value={email}
