...
// import { movies } from "../movieData";  // Import your full movieData.js
...
//   // Filter categories by caste field
...
//         />
//         <h3 className="text-lg font-semibold mb-2 text-white text-center">{movie.title}</h3>
...
//       <main className="ml-6 -mt-35 px-6">
...
//             <div className="flex gap-5 overflow-x-auto scrollbar-hide">
//               {shows.map(movie => <MovieCard key={movie.id} movie={movie} />)}
//             </div>
//           </section>
