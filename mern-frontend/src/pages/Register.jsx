...
export default function Register() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center loginBg pr-125">
      ...
      <form
        onSubmit={submit}
        className="relative z-10 w-full max-w-md p-10 rounded-2xl ml-100 backdrop-blur-md bg-black/60 border border-white/10 shadow-2xl"
      >
        ...
        <input
          className="w-full p-3 mb-4 rounded-lg bg-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 transition"
          placeholder="Name"
          value={name}
